var relearn_searchindex = [
  {
    ...
    "content": "PhD thesis There is an 1-year embargo on my thesis. It will be made available on HAL from 27th September, 2025.\nTeX template My thesis has been written using Overleaf. I simplified the document to build a template, so I hope one can easily build upon it. Find the template in Tools.",
    "description": "PhD thesis There is an 1-year embargo on my thesis. It will be made available on HAL from 27th September, 2025.\nTeX template My thesis has been written using Overleaf. I simplified the document to build a template, so I hope one can easily build upon it. Find the template in Tools.",
    "tags": [],
