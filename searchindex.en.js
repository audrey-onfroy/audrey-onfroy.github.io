var relearn_searchindex = [
  {
    ...
    "content": "PhD thesis I recently achieved my PhD thesis at Mondor Biomedical Research Institute, in Créteil, France. You can read more about my project:\non the theses.fr website ; on the global HAL website, and, on the thesis-related HAL website. TeX template My thesis has been written using Overleaf. I simplified the final document to build a template, so I hope one can easily build upon it. Find the template in Tools.",
    "description": "PhD thesis I recently achieved my PhD thesis at Mondor Biomedical Research Institute, in Créteil, France. You can read more about my project:\non the theses.fr website ; on the global HAL website, and, on the thesis-related HAL website. TeX template My thesis has been written using Overleaf. I simplified the final document to build a template, so I hope one can easily build upon it. Find the template in Tools.",
    "tags": [],
